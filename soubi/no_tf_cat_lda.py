...
lda_col = column_selector.get_lda_col()
predict_col.extend(lda_col)

train = pd.read_csv(CAT_LDA_TRAIN)
...
model = lgb.do_train_avito(X_train, X_valid, y_train, y_valid, predict_col)
