...
OUTPUT_PRED_11 = os.path.join(SUBMISSION, "submission11v.csv")
OUTPUT_PRED_52 = os.path.join(SUBMISSION, "submission52v.csv")
OUTPUT_PRED_54 = os.path.join(SUBMISSION, "submission54v.csv")
OUTPUT_PRED_71 = os.path.join(SUBMISSION, "submission71v.csv")
OUTPUT_PRED_99 = os.path.join(SUBMISSION, "submission99v.csv")
