...
print(train.info())
train = train[train["deal_probability"] > 0]
#train = train[train["price"] == 500]
#print(train["deal_probability"])
#exit(0)

group_mean = train.groupby("price")["deal_probability"].agg(["max", "count"]).reset_index()
group_mean = group_mean.sort_values("count", ascending=False)
print(group_mean)

# hmmm.... guess its parent?
