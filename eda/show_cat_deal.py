...
group_col = ["parent_category_name", "category_name", ]#"param_1", "param_2", "param_3"]
group_mean = train.groupby(group_col)["deal_probability"].agg(["max", "count"]).reset_index()
print(group_mean)

# KETURON: we should clip by parent_category_name
