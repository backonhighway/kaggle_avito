...
OUTPUT_PRED_1 = os.path.join(SUBMISSION, "lb_2198.csv")
OUTPUT_PRED_2 = os.path.join(SUBMISSION, "0612_vanilla.csv")
OUTPUT_PRED_3 = os.path.join(SUBMISSION, "0612_pl002.csv")
...
pred1 = dd.read_csv(OUTPUT_PRED_1).compute()
pred2 = dd.read_csv(OUTPUT_PRED_2).compute()
pred3 = dd.read_csv(OUTPUT_PRED_3).compute()
timer.time("read csv")
...
print(sub.describe())
sub["deal_probability"] = sub["pred1"] + sub["pred2"] + sub["pred3"]
sub["deal_probability"] = sub["deal_probability"] / 3
