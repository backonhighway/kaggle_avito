...
train_x = scipy.sparse.hstack([scipy.sparse.csr_matrix(train_x), dense_tf_train, title_cnt_train])
p_test_x = scipy.sparse.hstack([scipy.sparse.csr_matrix(p_test_x), dense_tf_test, title_cnt_test])
print(train_x.shape)
